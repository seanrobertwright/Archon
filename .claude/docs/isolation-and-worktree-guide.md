...
2. Branch merged into main → remove (if no uncommitted changes, no non-terminal workflow run owns it)
...
- Skip if uncommitted changes or a non-terminal workflow run owns it
