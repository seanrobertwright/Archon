...
export const PI_CREDENTIAL_SPECS: CredentialSpec[] = [
  ...
  { vendor: "qwen-token-plan", displayName: "Qwen Token Plan", kinds: ["api_key"] },
  { vendor: "qwen-token-plan-cn", displayName: "Qwen Token Plan Cn", kinds: ["api_key"] },
  { vendor: "qwen-token-plan-individual", displayName: "Qwen Token Plan Individual", kinds: ["api_key"] },
  { vendor: "radius", displayName: "Radius", kinds: ["api_key"] },
